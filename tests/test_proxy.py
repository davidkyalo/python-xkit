...
from zana.proxy import PromiseProxy, Proxy, unproxy
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (PromiseProxy(lambda: _object), _object),
    ],
)
...
class test_Proxy:
    def test_std_class_attributes(self):
        ...
        assert Proxy.__module__ == "zana.proxy"
...
class test_PromiseProxy:
    ...
    def test_callbacks(self):
        ...
        assert object.__getattribute__(p, "_PromiseProxy__pending")
